package org.dvaara.wso2.oauth2.token.handler.clientauth.mutualtls;
...
import org.dvaara.wso2.oauth2.token.handler.clientauth.mutualtls.utils.SpiffeMTLSUtil;
...
import static org.dvaara.wso2.oauth2.token.handler.clientauth.mutualtls.utils.SpiffeMTLSUtil.JAVAX_SERVLET_REQUEST_CERTIFICATE;
...
public class SpiffeMTLSClientAuthenticator extends AbstractOAuthClientAuthenticator {
    ...
    protected boolean authenticate(X509Certificate registeredCert, X509Certificate requestCert)
        ...
        try {
            String publicKeyOfRegisteredCert = SpiffeMTLSUtil.getThumbPrint(registeredCert);
            String publicKeyOfRequestCert = SpiffeMTLSUtil.getThumbPrint(requestCert);
