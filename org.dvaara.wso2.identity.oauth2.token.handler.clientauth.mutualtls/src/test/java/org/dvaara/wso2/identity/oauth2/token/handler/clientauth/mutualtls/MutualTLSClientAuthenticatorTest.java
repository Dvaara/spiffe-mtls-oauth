...
public class MutualTLSClientAuthenticatorTest extends PowerMockTestCase {
    ...
    private SpiffeMTLSClientAuthenticator mutualTLSClientAuthenticator = new SpiffeMTLSClientAuthenticator();
    ...
    public void testGetName() throws Exception {
        ...
        assertEquals("SpiffeMTLSClientAuthenticator", mutualTLSClientAuthenticator.getName(), "Mutual " +
