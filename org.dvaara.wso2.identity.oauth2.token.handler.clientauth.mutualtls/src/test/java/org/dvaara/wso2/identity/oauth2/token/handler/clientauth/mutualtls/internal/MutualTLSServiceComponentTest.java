    ...
    public void testActivate() throws Exception {
        ...
        doAnswer(new Answer<Object>() {
            ...
            public Object answer(InvocationOnMock invocation) throws Throwable {
                ...
                SpiffeMTLSClientAuthenticator mutualTLSClientAuthenticator = (SpiffeMTLSClientAuthenticator) invocation.getArguments()[1];
                serviceName[0] = mutualTLSClientAuthenticator.getClass().getName();
                return null;
            }
        }).when(bundleContext).registerService(anyString(), any(SpiffeMTLSClientAuthenticator.class), any(Dictionary.class));

        SpiffeMTLSServiceComponent mutualTLSServiceComponent = new SpiffeMTLSServiceComponent();
        mutualTLSServiceComponent.activate(context);

        assertEquals(SpiffeMTLSClientAuthenticator.class.getName(), serviceName[0], "error");
    }
